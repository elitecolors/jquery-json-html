class SimpleTableCellEdition {
    ...
    constructor(elem, _cellParams) {
        ...
        this.jsonValue = $(elem).attr('json-key');    
    }
...
class SimpleTableCellEditor {
    ...
    _EditCell(elem, cellParams) {
        ...
        var jsonValue=$(elem).attr('json-key');

        //Rendering 
        cellParams.internals.renderEditor(elem, oldVal,jsonValue);
    ...
    _GetDefaultInternals() {
        ...
        return {
            ...
            renderEditor: (elem, oldVal,jsonValue) => {
                console.log(jsonValue);
                $(elem).html(`<input class="`+jsonValue+`" value="" name="`+jsonValue+`" type='text' style="width:100%; max-width:none">`);
                //Focus part
